 ...
 * Use the [CamEditarproductoFragment.newInstance] factory method to
...
class CamEditarproductoFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val spinner = t.findViewById<Spinner>(R.id.SpinnerCategoriaProductosEditar)
        ...
        this.spinerCategoria = t.findViewById(R.id.SpinnerCategoriaProductosEditar)
